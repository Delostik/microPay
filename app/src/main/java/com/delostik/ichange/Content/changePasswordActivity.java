...
public class changePasswordActivity extends Activity {
    ...
    protected void  onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pnew.length() < 6 || pnew.length() > 20) {
                    Toast.makeText(changePasswordActivity.this, "密码长度必须为6-20位", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    Runnable changePassword = new Runnable() {
        ...
        public void run() {
            ...
            String strUrlPath = "http://121.40.194.163/microPay/index.php?s=/Home/User/changePwd.html";
