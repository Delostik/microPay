...
public class RechargeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RechargeActivity.this, ChangeCardActivity.class);
        ...
        btn_recharge.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (n <= 0) {
                    Toast.makeText(RechargeActivity.this, "金额必须大于0元", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
    ...
    Runnable recharge = new Runnable() {
        ...
        public void run() {
            ...
            String strUrlPath = "http://121.40.194.163/microPay/index.php?s=/Home/account/addMoney.html";
            String strResult= HttpUtils.submitPostData(strUrlPath, params, "utf-8");
            Message msg = new Message();
            Bundle data = new Bundle();
    ...
    private void returnRechargeRes() {
        if (rechargeRes == JSONObject.NULL) {
            ...
            if (code == 200) {
                ...
                Intent intent = new Intent(RechargeActivity.this, IndexActivity.class);
    ...
    private void returnCardRes() {
        ...
        try {
            ...
            Toast.makeText(RechargeActivity.this, "获取银行卡信息失败", Toast.LENGTH_SHORT).show();
            return;
        }
