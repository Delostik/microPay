...
public class ChangeCardActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ChangeCardActivity.this, "获取银行卡信息失败", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ChangeCardActivity.this, RechargeActivity.class);
